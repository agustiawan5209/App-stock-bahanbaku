                            ...
                            <div class="col-span-2 flex items-center p-4 bg-white rounded-lg shadow-lg">
                                ...
                                <div>
                                    <p class="mb-2 text-sm font-medium text-gray-600">
                                       <span class=" font-bold px-2 py-2 bg-black text-white rounded-md whitespace-pre"> Supplier : {{ $val->supplier->supplier }}</span>
<br><br>
                                        <span>{{ $val->default_stock->bahan_baku }}</span>
                                    </p>
                                    <p class="border-b border-black text-sm font-light text-gray-600">Deskripsi Produk
                                    </p>
                                    <p class="text-sm font-semibold text-gray-700">
                                        Isi : {{ $val->isi }}/{{ $val->satuan }} <br>
        ...
        <x-jet-dialog-modal wire:model="Additem" class="bg-blue-400 hover:bg-blue-500 rounded-lg" maxWidth='xl'>
                ...
                <form wire:submit.prevent>
                    <div class="flex flex-row justify-around items-center">
                        ...
                        <div>
                            ...
                            <x-jet-input class="block mt-1 w-full" wire:model='no_telpon' type="text"
                                name="no_telpon" required autofocus readonly />
                            @error('no_telpon')
                                <span class="text-red-500 text-xs italic">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="flex flex-row justify-around items-center">
                        <div>
                            ...
                            <x-jet-input class="block mt-1 w-full" wire:model.defer='bahan' type="text"
                                name="bahan" required autofocus readonly />
                            @error('bahan')
                                <span class="text-red-500 text-xs italic">{{ $message }}</span>
                            @enderror
                        </div>
                        <div>
                            ...
                            <x-jet-input class="block mt-1 w-full" wire:model='harga' type="text" name="harga"
                                required autofocus readonly />
                            @error('harga')
                                <span class="text-red-500 text-xs italic">{{ $message }}</span>
                            @enderror
                    ...
                    <div class="flex flex-row justify-around items-center">
                        <div>
                            ...
                            <x-jet-input class="block mt-1 w-full" wire:model='tgl' type="date" name="tgl"
                                required readonly />
                            @error('tgl')
                                <span class="text-red-500 text-xs italic">{{ $message }}</span>
                            @enderror
            ...
            <x-slot name="footer">
                <x-jet-button class="bg-blue-500 hover:bg-blue-700 rounded mr-4"
                    wire:click='kirim({{ $itemID }})'>
