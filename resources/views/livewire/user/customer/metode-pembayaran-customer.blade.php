                ...
                <div class="px-3 md:w-7/12 lg:pr-10">
                    <div class="w-full mx-auto text-gray-800 font-light mb-6 border-b border-gray-200 pb-6">
                        <div class="w-full flex items-center">
                            <div
                                class="overflow-hidden rounded-lg object-cover bg-gray-50 border border-gray-200">
                                <img src="{{ asset('img/blog/WhatsApp Image 2022-06-05 at 03.55.46.jpeg') }}" class="object-fill h-full" alt="">
                            </div>
                    ...
                    <div class="mb-6 pb-6 border-b border-gray-200 text-gray-800">
                        <div class="w-full flex items-center">
                            ...
                            <div class="pl-3">
                                <span class="font-semibold">{{ $sessi['jumlah_pesanan'] }}</span>
                            </div>
                        </div>
                        <div class="w-full flex items-center">
                            <div class="flex-grow">
                            ...
                            <div class="pl-3">
                                <span class="font-semibold">
                                    {{ 'Rp. ' . number_format(12800, 0, 2) }}</span>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="mb-3 -mx-2 flex items-end">
                                    <div class="px-2 w-1/2">
                                        ...
                                        <div>
                                            <input
                                                class="w-full px-3 py-2 mb-1 border border-gray-200 rounded-md focus:outline-none focus:border-indigo-500 transition-colors"
                                                placeholder="000" type="date" wire:model='tgl_transaksi' />
                                            @error('tgl_transaksi')
