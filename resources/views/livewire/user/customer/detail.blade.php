                        ...
                        <div class="mb-4">
                            ...
                            <div class=" bg-white lg:block">
                                ...
                                <ul class="py-6 border-b space-y-6 px-8">
                                        ...
                                        <div class="flex flex-col col-span-3 pt-2">
                                            ...
                                            <span class="text-gray-400 text-sm inline-block pt-2">
                                                <img src="{{ asset('bukti/' . $bukti_transaksi) }}"
                                                    class=" w-20 max-h-md shadow-lg rounded" alt="">
                                            </span>
                                        </div>
                                    </li>
                                    <li class="grid grid-cols-6 gap-2 border-b-1">
                                    ...
                                    <li class="grid grid-cols-6 gap-2 border-b-1">
                                        <div class="flex flex-col col-span-3 pt-2">
                                            <span class="text-gray-600 text-md font-semi-bold">Customer</span>
                                            <span
                                                class="text-gray-400 text-sm inline-block pt-2">{{ $customer }}</span>
                                        </div>
                                    </li>
                                </ul>
                                ...
                                <div class="font-semibold mt-5 text-xl px-8 flex justify-between text-gray-600">
                                    <span>Status Pemesanan</span>
                                    <span class="font-semibold text-xs text-gray-500">
                                        @if ($status == 'Belum Konfirmasi' || $status == "Belum Terkonfirmasi")
                                            {{ __('Belum Dikonfirmasi CV. THAHIRAH') }}
                                        @elseif ($status == 'Konfirmasi' || $status == "Selesai")
                                            {{ __('Sudah Dikonfirmasi CV. THAHIRAH') }}
                                            @else
                                            {{ __('Tidak Ada') }}
                                        @endif
                                    </span>
