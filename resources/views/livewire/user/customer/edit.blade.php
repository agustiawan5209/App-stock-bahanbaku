            ...
            <form>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="">
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput1"
                                class="block text-gray-700 text-sm font-bold mb-2">Kode Pesan:</label>
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput1"
                                class="block text-gray-700 text-sm font-bold mb-2">Tanggal Pemesanan:</label>
                            <input type="date" wire:model='tgl_pemesanan'
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="exampleFormControlInput1" placeholder="Enter Title" wire:model="title" readonly>
                            @error('tgl_pemesanan')
                                <span class="text-red-500">{{ $message }}</span>
                        ...
                        <div class="mb-4">
                            <label for="exampleFormControlInput1"
                                class="block text-gray-700 text-sm font-bold mb-2">Jumlah Pesanan Produk:</label>
                            <input type="number" wire:model='jumlah_pesanan' wire:keyup='getSubTotal'
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="exampleFormControlInput1" placeholder="Enter Title" wire:model="title">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" wire:model='sub_total'
                                class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="exampleFormControlInput1" placeholder="Enter Title" wire:model="title">
                            @error('sub_total')
                                <span class="text-red-500">{{ $message }}</span>
