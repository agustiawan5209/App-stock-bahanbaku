<header class="z-10 py-4 bg-gradient-to-tr from-navy to-blue-400 shadow-md   ">
    ...
    <div class="container flex items-center justify-between h-full px-6 mx-auto text-primary">
        ...
        <!-- Mobile hamburger -->
        <button class="p-1 mr-5 -ml-1 rounded-md focus:outline-none focus:shadow-outline-purple" @click="toggleSideMenu"
            aria-label="Menu">
