                            ...
                            <div class=" bg-white lg:block">
                                    ...
                                    <li class="grid grid-cols-6 gap-2 border-b-1">
                                        <div class="flex flex-col col-span-3 pt-2">
                                            ...
                                            <span class="text-gray-400 text-sm inline-block pt-2">
                                                <img src="{{asset('bukti/'. $bukti_transaksi)}}" class=" w-20 max-h-md shadow-lg rounded" alt="">
                                            </span>
                                        </div>
                                    </li>
                                    <li class="grid grid-cols-6 gap-2 border-b-1">
                                        <div class="flex flex-col col-span-3 pt-2">
                                            ...
                                            <span class="text-gray-400 text-sm inline-block pt-2">{{$ID_Transaksi}}</span>
                                        </div>
                                        <div class="col-span-2 pt-3">
                                            <div class="flex items-center space-x-2 text-sm justify-between">
                                                <span class="text-gray-400">Tanggal Transaksi</span>
                                                <span class="text-navy font-semibold inline-block whitespace-no-wrap">{{$tgl_transaksi}}</span>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="grid grid-cols-6 gap-2 border-b-1">
                                        <div class="flex flex-col col-span-3 pt-2">
                                            ...
                                            <span class="text-gray-400 text-sm inline-block pt-2">{{$metode}}</span>
                                        </div>
                                    </li>
                                    <li class="grid grid-cols-6 gap-2 border-b-1">
                                        <div class="flex flex-col col-span-3 pt-2">
                                            <span class="text-gray-600 text-md font-semi-bold">Supplier</span>
                                            <span class="text-gray-400 text-sm inline-block pt-2">{{$supplier}}</span>
                                        </div>
                                        <div class="col-span-2 pt-3">
                                            <div class="flex items-center space-x-2 text-sm justify-between">
                                                <span class="text-gray-400">Bahan Baku</span>
                                                <span class="text-navy font-semibold inline-block">{{$bahan}}</span>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                                <div class="px-8 border-b">
                                    <div class="flex justify-between py-4 text-gray-600">
                                        <span>Jumlah</span>
                                        <span class="font-semibold text-gray-500">{{number_format($jumlah, 0, 2) }} :{{$satuan}}</span>
                                    </div>
                                </div>
                                ...
                                <div class="font-semibold text-xl px-8 flex justify-between text-gray-600">
                                    ...
                                    <span class="font-semibold text-gray-500">
                                        @if ($status == 'Belum Konfirmasi')
                                            <span class="text-xs">{{ __('Belum Dikonfirmasi Supplier') }}</span>
                                        @elseif ($status == 'Konfirmasi' || $status == "Selesai")
                                            <span class="text-xs">{{ __('Sudah Dikonfirmasi Supplier') }}</span>
                                            @else
                                            <span class="text-xs">{{ __('Tidak Ada') }}</span>
                                        @endif
                                    </span>
                                </div>
                            </div>
