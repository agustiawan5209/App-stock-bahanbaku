<div x-show="{{$Alert}}" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0"
    ...
    <div x-show="{{$Alert}}" x-transition:enter="transition ease-out duration-150"
        ...
        <x-button type="button" wire:click='closeModal()'>Tutup</x-button>
    </div>
</div>
